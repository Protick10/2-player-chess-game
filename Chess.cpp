...
public:
    ...
    {
        cout<<endl<<endl;
        cout << "   >> Player 1's Side <<" << endl << endl;
        for(int i=0;i<9;i++)
        {
            for(int j=0;j<9;j++)
                cout<<str[i][j]<<"  ";
        ...
        cout << endl <<"   >> Player 2's Side <<" << endl;
        cout<<endl;
    }
};
...
int main()
{
    ...
    cout << "\t\t\t\t\   Let's Asume" << endl<<endl;
    cout << "\t\tBlack Turn(Player 1)\t\tWhite Turn(Player 2)" <<endl;
    cout << "\t\t--------------------\t\t--------------------" << endl;
    cout << "\t\tR = Rocks\t\t\tr = Rocks " << endl;
    cout << "\t\tN = Knights\t\t\tn = Knights" << endl;
    cout << "\t\tB = Bishops\t\t\tb = Bishops" << endl;
    cout << "\t\tK = King\t\t\tk = king" << endl;
    cout << "\t\tQ = Queen\t\t\tq = Queen" << endl;
    cout << "\t\tP = Pawns\t\t\tp = Pawns" << endl << endl;
    cout << "\t     >> BLACK(Player 1) Will always start the Game <<" << endl;
    obj.initializeboard();
